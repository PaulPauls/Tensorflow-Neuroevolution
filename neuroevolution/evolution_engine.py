...
class EvolutionEngine:
    def __init__(self, population, environment, config):
        self.population = population
        self.environment = environment

        # Declare and read in config parameters for the evolution engine
        self.max_generations_config = None
        self.fitness_threshold_config = None
